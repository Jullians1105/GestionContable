...
export default function TaskFilters({ filters, onChange, onClear }) {
  ...
  return (
    <div className="bg-white rounded-xl border border-[#c3c6d7] mb-6 shadow-sm overflow-hidden">
      ...
      >
        <span className="text-sm font-semibold text-[#191c1e] flex items-center gap-2">
          <span className="material-symbols-outlined text-base" style={{ color: '#004ac6' }}>filter_list</span>
          Filtros
          {hasActive && <span className="w-2 h-2 rounded-full flex-shrink-0" style={{ background: '#2563eb' }} />}
        </span>
      ...
      <div className={`p-4 flex flex-wrap items-end gap-3 ${expanded ? 'flex' : 'hidden'} lg:flex`}>
        ...
        <div className="flex flex-col gap-1 w-full sm:w-auto">
          <label className="text-xs font-semibold text-[#434655] px-1">Buscar</label>
        ...
        <div className="flex flex-col gap-1 w-full sm:w-auto">
          <label className="text-xs font-semibold text-[#434655] px-1">Estado</label>
        ...
        <div className="flex flex-col gap-1 w-full sm:w-auto">
          <label className="text-xs font-semibold text-[#434655] px-1">Prioridad</label>
        ...
        <div className="flex flex-col gap-1 w-full sm:w-auto">
          <label className="text-xs font-semibold text-[#434655] px-1">Asignado</label>
        ...
        <div className="flex flex-col gap-1 w-full sm:w-auto">
          <label className="text-xs font-semibold text-[#434655] px-1">Grupo</label>
        ...
        <div className="flex flex-col gap-1 w-full sm:w-auto">
          <label className="text-xs font-semibold text-[#434655] px-1">Etiqueta</label>
        ...
        <div className="flex flex-col gap-1 w-full sm:w-auto">
          <label className="text-xs font-semibold text-[#434655] px-1">&nbsp;</label>
          <label className="h-10 flex items-center gap-2 px-3 border border-[#c3c6d7] rounded-lg text-sm text-[#191c1e] bg-white cursor-pointer select-none w-full sm:w-auto">
            <input
              type="checkbox"
        ...
        {hasActive && (
          <button
            onClick={onClear}
            className="h-10 px-4 text-xs font-semibold text-[#434655] flex items-center gap-1.5 hover:bg-[#edeef0] rounded-lg transition border border-[#c3c6d7] w-full sm:w-auto justify-center sm:justify-start"
          >
