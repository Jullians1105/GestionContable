  ...
  return (
    <div className="min-h-screen bg-[#f3f4f6] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md border border-[#c3c6d7]">
        ...
        <h2 className="text-xl font-bold text-[#191c1e] mb-1">Restablecer contraseña</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-semibold text-[#434655] mb-1.5">Token</label>
            <input
              type="text"
              value={token}
          ...
          <div>
            <label className="block text-xs font-semibold text-[#434655] mb-1.5">Confirmar contraseña</label>
            <input
              type="password"
      ...
      {showSuccess && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 border border-[#c3c6d7] text-center">
            ...
            <h3 className="text-lg font-bold text-[#191c1e] mb-1">¡Contraseña actualizada!</h3>
            <p className="text-sm text-[#434655] mb-6">
              Tu contraseña se restableció correctamente. Ya puedes iniciar sesión.
            </p>
            <button onClick={goToLogin} className="w-full h-10 rounded-lg text-sm font-semibold text-white transition" style={{ background: '#2563eb' }}>
              Ir a iniciar sesión
            </button>
          </div>
        </div>
